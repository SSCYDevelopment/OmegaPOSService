...
AS
   ...
   (
      ...
      tsuspendnum varchar( 50 ) DEFAULT '',
   ...
   SET    twwscard = wwscard,
          tsalm = salm,
          tsuspendnum = SuspendNum
   FROM   crcarh
   WHERE  cartid = tcardID

   SELECT a.tcardID CartID,a.ttime [SuspendTime],a.tqty [Qty],a.tamt [Amount],a.twwscard [MemberCard],a.tsalm [SalesAssociate],tsuspendnum SuspendNum
   FROM   #t a
   ORDER  BY ttime DESC 
